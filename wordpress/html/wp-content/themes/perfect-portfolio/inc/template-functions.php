...
<!DOCTYPE html>
  <html <?php language_attributes(); ?>>
    ...
    <link rel="stylesheet" href="https://use.typekit.net/wwr2asp.css">
  ...
  */
  ...
  <div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#main-content-area">
      <?php esc_html_e( 'Skip to content (Press Enter)', 'perfect-portfolio' ); ?>
    </a>
    <?php
  }
  endif;
      ...
      function perfect_portfolio_content_start(){ 
        ...
        if( !( is_front_page() && ! is_home() && $home_sections ) ){ ?>
          <div id="content" class="site-content">
            ...
            <<?php echo $add_tag_name; ?> class="page-
              <?php echo esc_attr( $add_class_name ); ?>">
  ...
  if( $previous || $next ){?>
    <nav class="navigation post-navigation" role="navigation">
      <h2 class="screen-reader-text">
        <?php esc_html_e( 'Post Navigation', 'perfect-portfolio' ); ?>
      </h2>
      <div class="nav-links">
        <?php
